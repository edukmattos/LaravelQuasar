    ...
    getAuthUserCompaniesFiltered: (state, getters) => {
        ...
        if (state.search) {
            Object.keys(authUserCompaniesSorted).forEach((key) => {
                ...
                // console.log(companyNameLowerCase.includes(searchLowerCase))
                if (companyNameLowerCase.includes(searchLowerCase) || companyFullNameLowerCase.includes(searchLowerCase) || company.einssa.includes(searchLowerCase)) {
