...
$api->version('v1', function (Router $api) {
    $api->group(['middleware' => 'cors'], function(Router $api) {
        $api->get('/clientTypes', 'App\\Api\\V1\\Controllers\\ClientTypesController@index')->name('clientTypes.index');
        $api->get('/clientStatuses', 'App\\Api\\V1\\Controllers\\ClientStatusesController@index')->name('clientStatuses.index');
        $api->get('/clientLocationTypes', 'App\\Api\\V1\\Controllers\\ClientLocationTypesController@index')->name('clientLocationTypes.index');
        $api->get('/clientLocations', 'App\\Api\\V1\\Controllers\\ClientLocationsController@index')->name('clientLocations.index');
        ...
        $api->group(['middleware' => 'jwt.auth'], function(Router $api) {
            ...
            $api->get('/clients', 'App\\Api\\V1\\Controllers\\ClientsController@index')->name('clients.index');
            $api->post('/clients', 'App\\Api\\V1\\Controllers\\ClientsController@store')->name('clients.store');
            $api->get('/clients/{id}', 'App\\Api\\V1\\Controllers\\ClientsController@show')->name('clients.show');
            ######
