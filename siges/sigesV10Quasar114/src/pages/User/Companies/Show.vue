<template>  
  <div class="q-pa-xs">
    ...
    <q-card>
      <q-img src="https://cdn.quasar.dev/img/parallax2.jpg">
        <div class="absolute-bottom">
          ...
          <div class="text-h8" :style="this.deleted ? 'text-decoration:line-through' : ''">{{ getCompanyById(id).einssa }}</div>
    ...
    <q-page-sticky position="top-right" :offset="[20, 37]">
      <q-fab
      ...
      >
        ...
        <q-fab-action v-if="!getCompanyById(id).deleted" @click="setCompanyIn(id)" color="primary" icon="done" />
        <q-fab-action v-if="!getCompanyById(id).deleted" @click="formCompanyNewEdit = true" color="secondary" icon="edit" />
        <q-fab-action v-if="!getCompanyById(id).deleted" @click="promptToDelete(id)" color="negative" icon="delete" />
      </q-fab>
    </q-page-sticky>
